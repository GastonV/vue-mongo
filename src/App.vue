...
<template>
  <div class="">
    ...
    >
      <h1 class="text-xl text-indigo-900">Lizard Game</h1>
      <button
      ...
      <ul className="w-auto">
        ...
        >
          ...
          <section className="capitalize">
            ...
            <p className="text-indigo-500 font-medium text-sm mb-2">
              {{ user.title }}
            </p>
            <div className="flex text-sm capitalize">
              <button
                  className="text-red-500 px-4 py-2 mr-4 border border-red-500 rounded-md"
                  @click="deleteAUser(user._id)"
              >
                delete
              </button>
              <button
                  className="text-white px-4 py-2 bg-indigo-900 rounded-md"
